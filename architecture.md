...
```mermaid
flowchart TD
  User["사용자"] --> Presentation["presentation 화면"]
  Presentation --> Application["application 앱 흐름"]
  Application --> Domain["domain 계산 규칙"]
  Application --> Data["data 저장 기능"]
  Data --> Local["기기 내부 저장소"]
```
